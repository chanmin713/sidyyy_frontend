...
export const popularRecruits: SidebarRecruit[] = [
  {
    ...
    position: '시니어 프론트엔드',
    description:
      '혁신적인 웹 서비스를 개발하는 테크 스타트업에서 React, TypeScript를 활용한 프론트엔드 개발자를 모집합니다.',
    deadline: '2024-02-15',
    stats: {
      applicants: 24,
      views: 450,
  ...
  },
  {
    ...
    position: '풀스택 개발자',
    description:
      '금융 서비스 플랫폼을 개발하는 핀테크 회사에서 Node.js, React를 사용한 풀스택 개발자를 찾습니다.',
    deadline: '2024-02-20',
    stats: {
      applicants: 18,
      views: 380,
  ...
  },
  {
    ...
    position: '시니어 디자이너',
    description:
      '다양한 클라이언트의 브랜드 아이덴티티와 사용자 경험을 설계하는 디자이너를 모집합니다.',
    deadline: '2024-02-18',
    stats: {
      applicants: 12,
      views: 320,
  ...
  },
  {
    ...
    position: '백엔드 개발자',
    description:
      '대규모 클라우드 서비스의 안정적인 백엔드 시스템을 구축하고 유지보수하는 개발자를 찾습니다.',
    deadline: '2024-02-25',
    stats: {
      applicants: 16,
      views: 290,
  ...
  },
  {
    ...
    description:
      '클라우드 인프라 구축과 CI/CD 파이프라인을 관리하는 DevOps 엔지니어를 모집합니다.',
    deadline: '2024-02-22',
    stats: {
      applicants: 14,
      views: 260,
  ...
  },
  {
    ...
    description:
      '머신러닝 모델 개발과 데이터 분석을 통해 AI 솔루션을 연구하고 개발하는 데이터 사이언티스트를 모집합니다.',
    deadline: '2024-02-28',
    stats: {
      applicants: 20,
      views: 410,
  ...
  },
  {
    ...
    description:
      '금융 서비스 모바일 앱을 개발하는 핀테크 회사에서 React Native, Swift, Kotlin을 사용한 개발자를 찾습니다.',
    deadline: '2024-02-26',
    stats: {
      applicants: 15,
      views: 340,
  ...
  },
  {
    ...
    position: '머신러닝 엔지니어',
    description:
      '헬스케어 분야의 AI 솔루션을 개발하는 테크 회사에서 TensorFlow, PyTorch를 활용한 머신러닝 엔지니어를 모집합니다.',
    deadline: '2024-03-01',
    stats: {
      applicants: 22,
      views: 480,
  ...
  },
  {
    ...
    position: '시큐리티 엔지니어',
    description:
      '금융 서비스의 보안 시스템을 구축하고 관리하는 시큐리티 엔지니어를 모집합니다.',
    deadline: '2024-02-24',
    stats: {
      applicants: 11,
      views: 220,
  ...
  },
  {
    ...
    position: '시니어 PM',
    description:
      '대규모 이커머스 플랫폼의 제품 전략을 수립하고 개발팀과 협업하는 프로덕트 매니저를 모집합니다.',
    deadline: '2024-02-29',
    stats: {
      applicants: 19,
      views: 360,
