        ...
        <div className="flex items-center justify-between">
              ...
              <div className="animate-in fade-in-0 slide-in-from-top-2 duration-300">
                <div className="relative">
                  <input
                    ...
                    className="w-full py-3 px-4 pr-12 bg-white/20 backdrop-blur-md border border-white/30 rounded-xl focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-white/50 shadow-lg transition-all duration-300 placeholder:text-gray-600"
                    autoFocus
                  />
                  <button
                    onClick={() => setIsSearchOpen(false)}
                    className="absolute right-3 top-1/2 transform -translate-y-1/2 w-7 h-7 flex items-center justify-center hover:bg-white/20 rounded-lg transition-all duration-200 hover:scale-110 group"
                  >
                    <Cross2Icon className="w-4 h-4 text-gray-600 group-hover:text-gray-800 transition-colors duration-200" />
                  </button>
                </div>
              </div>
            )}
          ...
          <div className="flex items-center gap-4">
            <button 
              ...
              className={`w-8 h-8 flex items-center justify-center rounded-lg transition-all duration-200 hover:scale-110 group ${
                isSearchOpen 
