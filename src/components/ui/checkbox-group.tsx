...
export function CheckboxGroup({ values, onValuesChange, children, className = '' }: CheckboxGroupProps) {
  return (
...
export function CheckboxItem({ value, values, onValuesChange, children, className = '' }: CheckboxItemProps) {
